/*
  # Add Total Deposited and Total Paid Out to Analytics

  1. Updates
    - Adds total_deposited: Sum of all completed deposit transactions
    - Adds total_paid_out: Sum of all completed payout transactions
    - Updates get_analytics_data() function to include these metrics

  2. Return Structure
    - total_deposited: Total amount deposited by all users
    - total_paid_out: Total amount paid out to all users
*/
