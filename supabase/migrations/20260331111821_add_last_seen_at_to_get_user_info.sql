/*
  # Add last_seen_at to get_user_info Function

  1. Changes
    - Drops and recreates the get_user_info function to include last_seen_at timestamp
    - This allows the admin dashboard to calculate if a user is inactive (14+ days)
    
  2. Purpose
    - Enables the "Inactive User Reminder" notification in the Send Re-engagement Alert modal
    - Provides visibility into user activity patterns
*/
