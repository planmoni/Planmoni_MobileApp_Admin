/*
  ...
  1. New Functions
    - `get_dashboard_stats()` - Returns comprehensive dashboard statistics including:
      - Total users count
      - Total deposits amount
      - Total payouts amount  
      - Total payout plans count
      - Transaction trends for the last 7 days
  ...
  3. Performance
    ...
    - Optimized aggregations for better performance
*/
