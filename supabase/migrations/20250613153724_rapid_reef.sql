/*
  # Super Admin System with Roles and Permissions
  
  1. New Tables
    - roles: Define system roles (Super Admin, Admin, Moderator, User)
    - permissions: Define granular permissions
    - role_permissions: Link roles to permissions
    - user_roles: Assign roles to users
    - permission_categories: Group permissions by category
    - audit_logs: Track admin actions
  
  2. Security
    - Enable RLS on all tables
    - Add policies for super admin access
    - Create functions for role/permission management
