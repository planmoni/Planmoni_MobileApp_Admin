-- Fix users_with_plans to count ALL users with any payout plan (not just active)
-- Also fix total_plans_amount to sum locked_balance for all users with any plan
