/*
  # Create Admin User and Setup Super Admin Role
  
  1. Create admin user in auth.users if it doesn't exist
  2. Create profile for admin user
  3. Assign Super Admin role to admin user
  4. Ensure all permissions are properly set up
*/
...
BEGIN
  ...
  IF admin_user_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'Admin user ID: %, is_super_admin: %', admin_user_id, is_super_admin_result;
  ELSE
