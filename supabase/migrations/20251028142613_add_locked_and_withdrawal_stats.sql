/*
  # Add Locked Balance and Emergency Withdrawal Stats

  1. Changes
    - Adds total_locked_balance: Sum of all locked_balance from wallets
    - Adds total_emergency_withdrawals: Sum of completed withdrawal transactions

  2. New Return Fields
    - total_locked_balance: Total amount locked in wallets for payouts
    - total_emergency_withdrawals: Total amount of completed withdrawal transactions
*/
